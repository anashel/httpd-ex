...
module.exports = "<nav class=\"navbar navbar-dark justify-content-between\">\r\n\r\n  <a class=\"navbar-brand\" href=\"#\">\r\n    <img src=\"http://saltonlineordering.com/uploads/7/3/8/9/73898955/editor/sogbu-restaurant-logo-5.png?1497391256\" width=\"80\"\r\n      class=\"d-inline-block align-top\" alt=\"\"> Bootstrap\r\n  </a>\r\n  <form class=\"form-inline my-1\">\r\n\r\n    <button type=\"submit\" class=\"btn btn-primary btn-sm\" (click)=\"logoutUser()\">Logout</button>\r\n    <button type=\"submit\" class=\"btn btn-primary btn-sm\" routerLink=\"mdb-home\" href=\"#loginBlock\">Home</button>\r\n    <button type=\"submit\" class=\"btn btn-primary btn-sm\" routerLink=\"mdb-edit\" href=\"#loginBlock\">Edit</button>\r\n  </form>\r\n</nav>\r\n\r\n\r\n\r\n\r\n\r\n\r\n<div *ngIf=\"loggedIn == true; else loginBlock\" #mainBlock>\r\n  <!-- Will contain pages -->\r\n  <router-outlet></router-outlet>\r\n</div>\r\n\r\n\r\n<ng-template #loginBlock>\r\n  <div class=\"row mt-5\">\r\n    <div class=\"col-md-12 text-center\">\r\n      <h1 class=\"h1-responsive\">Login:</h1>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col-sm-4\"></div>\r\n    <div class=\"col-sm-4\">\r\n      <!-- Horizontal material form -->\r\n      <form>\r\n        <!-- Grid row -->\r\n        <div class=\"form-group row\">\r\n          <!-- Material input -->\r\n          <!--label for=\"inputEmail3MD\" class=\"col-sm-2 col-form-label\" data-error=\"wrong\" data-success=\"right\">Email</label-->\r\n          <div class=\"col-sm-10\">\r\n            <div class=\"md-form mt-0\">\r\n              <i class=\"fa fa-envelope prefix\"></i>\r\n              <input type=\"email\" class=\"form-control validate\" id=\"inputEmail3MD\" placeholder=\"Email\">\r\n\r\n\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <!-- Grid row -->\r\n\r\n        <!-- Grid row -->\r\n        <div class=\"form-group row\">\r\n          <!-- Material input -->\r\n          <!--label for=\"inputPassword3MD\" class=\"col-sm-2 col-form-label\">Password</label-->\r\n          <div class=\"col-sm-10\">\r\n            <div class=\"md-form mt-0\">\r\n              <i class=\"fa fa-lock prefix\"></i>\r\n              <input type=\"password\" class=\"form-control\" id=\"inputPassword3MD\" placeholder=\"Password\">\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <!-- Grid row -->\r\n\r\n        <!-- Grid row -->\r\n        <div class=\"form-group row text-center\">\r\n          <div class=\"col-sm-10\">\r\n            <button type=\"submit\" class=\"btn btn-primary btn-lg\" (click)=\"loginUser()\">Sign in</button>\r\n          </div>\r\n        </div>\r\n        <!-- Grid row -->\r\n      </form>\r\n      <!-- Horizontal material form -->\r\n\r\n    </div>\r\n    <div class=\"col-sm-4\"></div>\r\n  </div>\r\n\r\n\r\n</ng-template>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__categories_category_data_service__ = __webpack_require__("./src/app/categories/category-data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__todos_todo__ = __webpack_require__("./src/app/todos/todo.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__todos_todo_data_service__ = __webpack_require__("./src/app/todos/todo-data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__categories_category__ = __webpack_require__("./src/app/categories/category.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(todoDataService, categoryDataService) {
        this.todoDataService = todoDataService;
        this.categoryDataService = categoryDataService;
        this.newTodo = new __WEBPACK_IMPORTED_MODULE_2__todos_todo__["a" /* Todo */]();
        this.newCategory = new __WEBPACK_IMPORTED_MODULE_4__categories_category__["a" /* Category */]();
        this.loggedIn = false;
        this.navigat = 'edit';
    }
    ...
    AppComponent.prototype.loginUser = function () {
        ...
        localStorage.setItem("user", "anas");
    };
    ...
    Object.defineProperty(AppComponent.prototype, "todosForCat", {
        get: function () {
    ...
    AppComponent.prototype.countTodosByCat = function (id) {
    ...
    AppComponent.prototype.removeCategory = function (category) {
        this.categoryDataService.deleteCategoryById(category.id);
    };
    Object.defineProperty(AppComponent.prototype, "categories", {
        get: function () {
    ...
    AppComponent.prototype.categoryById = function (id) {
        return this.categoryDataService.getCategoryById(id);
    };
    AppComponent.prototype.addInitialCategory = function (category) {
        this.categoryDataService.addCategory(category);
    };
    AppComponent.prototype.addInitialTodo = function (todo) {
    ...
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__todos_todo_data_service__["a" /* TodoDataService */], __WEBPACK_IMPORTED_MODULE_0__categories_category_data_service__["a" /* CategoryDataService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__todos_todo_data_service__["a" /* TodoDataService */], __WEBPACK_IMPORTED_MODULE_0__categories_category_data_service__["a" /* CategoryDataService */]])
    ], AppComponent);
    return AppComponent;
}());
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_7__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_8__components_home_home_component__["a" /* HomeComponent */], __WEBPACK_IMPORTED_MODULE_10__components_edit_edit_component__["a" /* EditComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__angular_router__["b" /* RouterModule */].forRoot([
                    ...
                    {
                        path: 'mdb-edit',
                        component: __WEBPACK_IMPORTED_MODULE_10__components_edit_edit_component__["a" /* EditComponent */]
                    }
                ]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__category__ = __webpack_require__("./src/app/categories/category.ts");
...
var CategoryDataService = /** @class */ (function () {
    function CategoryDataService(http) {
        ...
        this.categories = [];
        this.myArrays = [];
        this.categoriesURL = "http://falling-surf-6268.getsandbox.com/hello";
        this.populateCategories();
        this.testService();
    }
    CategoryDataService.prototype.callRestService = function () {
        var _this = this;
        this.http.get(this.categoriesURL).subscribe(function (data) {
    ...
    ;
    CategoryDataService.prototype.testService = function () {
        ...
        this.http.get('http://falling-surf-6268.getsandbox.com/hello').subscribe(function (data) {
            console.log(data);
        });
    };
    // Simulate POST /categories
    CategoryDataService.prototype.addCategory = function (category) {
        if (!category.id) {
    ...
    CategoryDataService.prototype.deleteCategoryById = function (id) {
        this.categories = this.categories
            .filter(function (category) { return category.id !== id; });
        return this;
    };
    // Simulate PUT /categories/:id
    CategoryDataService.prototype.updateCategoryById = function (id, values) {
    ...
    CategoryDataService.prototype.getCategoryById = function (id) {
        return this.categories
            .filter(function (category) { return category.id === id; })
            .pop();
    };
    CategoryDataService.prototype.populateCategories = function () {
        for (var i = 0; i < 10; i++) {
            var categ = new __WEBPACK_IMPORTED_MODULE_1__category__["a" /* Category */]();
            categ.name = "Automatic Category " + i;
            categ.id = i;
...
var EditComponent = /** @class */ (function () {
    function EditComponent(todoDataService, categoryDataService) {
        this.todoDataService = todoDataService;
        this.categoryDataService = categoryDataService;
    ...
    EditComponent.prototype.selectTab = function (tab) {
        this.navigat = tab;
    };
    EditComponent.prototype.addTodo = function () {
        this.newTodo.category = this.selectedCategory.id;
        this.todoDataService.addTodo(this.newTodo);
        this.newTodo = new __WEBPACK_IMPORTED_MODULE_2__todos_todo__["a" /* Todo */]();
    };
    EditComponent.prototype.loginUser = function () {
        this.loggedIn = true;
    };
    EditComponent.prototype.logoutUser = function () {
        this.loggedIn = false;
    };
    EditComponent.prototype.toggleTodoComplete = function (todo) {
        this.todoDataService.toggleTodoComplete(todo);
    };
    EditComponent.prototype.removeTodo = function (todo) {
        this.todoDataService.deleteTodoById(todo.id);
    };
    Object.defineProperty(EditComponent.prototype, "todos", {
        get: function () {
            return this.todoDataService.getAllTodos();
        },
        enumerable: true,
    ...
    Object.defineProperty(EditComponent.prototype, "todosForCat", {
        get: function () {
            return this.todoDataService.getTodoByCategory(this.selectedCategory.id);
        },
        enumerable: true,
    ...
    EditComponent.prototype.countTodosByCat = function (id) {
        return this.todoDataService.getTodoByCategory(id).length;
    };
    EditComponent.prototype.addCategory = function () {
        this.categoryDataService.addCategory(this.newCategory);
        this.newCategory = new __WEBPACK_IMPORTED_MODULE_4__categories_category__["a" /* Category */]();
    };
    EditComponent.prototype.removeCategory = function (category) {
        this.categoryDataService.deleteCategoryById(category.id);
    };
    Object.defineProperty(EditComponent.prototype, "categories", {
        get: function () {
            return this.categoryDataService.getAllCategories();
        },
        enumerable: true,
    ...
    EditComponent.prototype.categoryById = function (id) {
        return this.categoryDataService.getCategoryById(id);
    };
    EditComponent.prototype.addInitialCategory = function (category) {
        this.categoryDataService.addCategory(category);
    };
    EditComponent.prototype.addInitialTodo = function (todo) {
        this.todoDataService.addTodo(todo);
    };
    EditComponent.prototype.onSelect = function (category) {
        this.selectedCategory = category;
        console.log(category);
    };
...
module.exports = "<div *ngIf=\"myUser != null;\">\n\n    <p>\n        {{myUser}}\n    </p>\n\n    <push-notification title=\"Getting Started\" body=\"A simple npm install can get you there\" icon=\"https://goo.gl/3eqeiE\">\n    test\n    </push-notification>\n\n    <button (click)=\"sendIn('Test Anas')\">Send Message</button>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(todoDataService, categoryDataService) {
        this.todoDataService = todoDataService;
        this.categoryDataService = categoryDataService;
        this.herbs = [];
        this.myUser = localStorage.getItem("user");
    ...
    Object.defineProperty(HomeComponent.prototype, "todos", {
        get: function () {
            return this.todoDataService.getAllTodos();
        },
        enumerable: true,
    ...
    Object.defineProperty(HomeComponent.prototype, "todosForCat", {
        get: function () {
            return this.todoDataService.getTodoByCategory(this.selectedCategory.id);
        },
        enumerable: true,
    ...
    HomeComponent.prototype.countTodosByCat = function (id) {
        return this.todoDataService.getTodoByCategory(id).length;
    };
    ...
    HomeComponent.prototype.removeCategory = function (category) {
        this.categoryDataService.deleteCategoryById(category.id);
    };
    ...
    HomeComponent.prototype.categoryById = function (id) {
        return this.categoryDataService.getCategoryById(id);
    };
    HomeComponent.prototype.addInitialCategory = function (category) {
        this.categoryDataService.addCategory(category);
    };
    HomeComponent.prototype.addInitialTodo = function (todo) {
        this.todoDataService.addTodo(todo);
    };
    HomeComponent.prototype.onSelect = function (category) {
        this.selectedCategory = category;
        console.log(category);
    };
...
var TodoDataService = /** @class */ (function () {
    ...
    TodoDataService.prototype.getTodoByCategory = function (id) {
        return this.todos
            .filter(function (todo) { return todo.category === id; });
    };
...
var LinksComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["r" /* ContentChildren */])(__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* RouterLinkWithHref */], { read: __WEBPACK_IMPORTED_MODULE_1__angular_core__["t" /* ElementRef */], descendants: true }),
